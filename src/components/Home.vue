            ...
            <el-table-column label="Work" width="180">
              <template #default="scope">
                <el-popover
                  ...
                  width="auto"
                >
                  <template #default>  // el-popover的默认插槽，定义弹出框内容
...
import { throttle } from "../utils/utils"; // 引入节流函数
...
const handleFileChange = async (
  ...
  const formData = new FormData();  // 将文件数据编码为multipart/form-data格式
